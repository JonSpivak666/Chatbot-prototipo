...
if prompt:
    ...
    if st.session_state.fase == "inicio":
        respuesta = "Hola, soy Álvaro Medina. ¿Qué producto de software te interesa cotizar? Puedes escribir el nombre como 'Software A', 'Software B', etc."
        ...
        if seleccionados:
            ...
            respuesta = f"He encontrado los siguientes productos: {', '.join(seleccionados)}. ¿Deseas generar la cotización ahora?"
            st.session_state.fase = "confirmar_cotizacion"
        else:
            respuesta = "No encontré ese producto en mi catálogo. Por favor, intenta con 'Software A' hasta 'Software L'."
        ...
        if "sí" in prompt.lower() or "si" in prompt.lower():
            ...
            respuesta = f"Perfecto. Aquí está tu cotización:\n{productos_str}\n\nTotal: ${total:.2f} MXN. ¿Cuál es tu nombre completo para registrar esta cotización?"
        ...
        respuesta = f"Gracias, {st.session_state.nombre}. Tu cotización ha sido registrada. Uno de nuestros colaboradores te atenderá a la brevedad."
